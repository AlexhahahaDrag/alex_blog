...
public class Vo implements ITemplate {
    ...
    public static class Builder extends BaseBuilder {
        ...
        public Vo.Builder nameConvert(INameConvert nameConvert) {
        ...
        public Vo.Builder disableSerialVersionUID() {
            this.vo.serialVersionUID = false;
            return this;
        }

        public Vo.Builder enableColumnConstant() {
            this.vo.columnConstant = true;
            return this;
        }

        public Vo.Builder enableChainModel() {
            this.vo.chain = true;
            return this;
        }

        public Vo.Builder enableLombok() {
            this.vo.lombok = true;
            return this;
        }

        public Vo.Builder enableRemoveIsPrefix() {
            this.vo.booleanColumnRemoveIsPrefix = true;
            return this;
        }

        public Vo.Builder enableTableFieldAnnotation() {
            this.vo.tableFieldAnnotationEnable = true;
            return this;
        }

        public Vo.Builder enableActiveRecord() {
            this.vo.activeRecord = true;
            return this;
        }

        public Vo.Builder versionColumnName(String versionColumnName) {
            this.vo.versionColumnName = versionColumnName;
            return this;
        }

        public Vo.Builder versionPropertyName(String versionPropertyName) {
            this.vo.versionPropertyName = versionPropertyName;
            return this;
        }

        public Vo.Builder logicDeleteColumnName(String logicDeleteColumnName) {
            this.vo.logicDeleteColumnName = logicDeleteColumnName;
            return this;
        }

        public Vo.Builder logicDeletePropertyName(String logicDeletePropertyName) {
            this.vo.logicDeletePropertyName = logicDeletePropertyName;
            return this;
        }

        public Vo.Builder naming(NamingStrategy namingStrategy) {
            this.vo.naming = namingStrategy;
            return this;
        }

        public Vo.Builder columnNaming(NamingStrategy namingStrategy) {
            this.vo.columnNaming = namingStrategy;
            return this;
        }

        public Vo.Builder addSuperVoColumns(@NotNull String... superVoColumns) {
            this.vo.superVoColumns.addAll(Arrays.asList(superVoColumns));
            return this;
        }

        public Vo.Builder addIgnoreColumns(@NotNull String... ignoreColumns) {
            this.vo.ignoreColumns.addAll(Arrays.asList(ignoreColumns));
            return this;
        }

        public Vo.Builder addTableFills(@NotNull IFill... tableFill) {
            this.vo.tableFillList.addAll(Arrays.asList(tableFill));
            return this;
        }

        public Vo.Builder addTableFills(@NotNull List<IFill> tableFillList) {
            this.vo.tableFillList.addAll(tableFillList);
            return this;
        }

        public Vo.Builder idType(IdType idType) {
            this.vo.idType = idType;
            return this;
        }

        public Vo.Builder convertFileName(@NotNull ConverterFileName converter) {
