...
public class Controller implements ITemplate {
    ...
    public static class Builder extends BaseBuilder {
        ...
        public Controller.Builder superClass(@NotNull Class<?> clazz) {
            return this.superClass(clazz.getName());
        }

        public Controller.Builder superClass(@NotNull String superClass) {
        ...
        public Controller.Builder convertFileName(@NotNull ConverterFileName converter) {
            this.controller.converterFileName = converter;
            return this;
        }

        public Controller.Builder formatFileName(@NotNull String format) {
