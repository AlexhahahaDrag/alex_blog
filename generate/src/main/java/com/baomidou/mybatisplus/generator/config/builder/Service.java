...
public class Service implements ITemplate {
    ...
    public static class Builder extends BaseBuilder {
        ...
        public Service.Builder superServiceClass(@NotNull Class<?> clazz) {
            return this.superServiceClass(clazz.getName());
        }

        public Service.Builder superServiceClass(@NotNull String superServiceClass) {
            this.service.superServiceClass = superServiceClass;
            return this;
        }

        public Service.Builder superServiceImplClass(@NotNull Class<?> clazz) {
            return this.superServiceImplClass(clazz.getName());
        }

        public Service.Builder superServiceImplClass(@NotNull String superServiceImplClass) {
            this.service.superServiceImplClass = superServiceImplClass;
            return this;
        }

        public Service.Builder convertServiceFileName(@NotNull ConverterFileName converter) {
            this.service.converterServiceFileName = converter;
            return this;
        }

        public Service.Builder convertServiceImplFileName(@NotNull ConverterFileName converter) {
            this.service.converterServiceImplFileName = converter;
            return this;
        }

        public Service.Builder formatServiceFileName(@NotNull String format) {
            return this.convertServiceFileName((entityName) -> {
                return String.format(format, entityName);
            });
        }

        public Service.Builder formatServiceImplFileName(@NotNull String format) {
